    ...
    <div class="container-sl">
        <div class="carousel">
            @foreach($images as $image)
                <div class="tw-h-[60vh] lg:tw-h-[100vh] tw-bg-cover tw-bg-no-repeat tw-bg-fixed  tw-bg-center"
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="title">
                        <h2>Events & News</h2>
                        <p class="text">
                            We are always ready to serve you with the best of our services,you read our news and events
                    ...
                    <a href="{{ route('events') }}"
                       class="btn btn-outline-primary btn-outline shadow rounded-pill btn-sm">
                        Check out our news
                        <span class="svg-icon">
